# Resolvendo Códigos em PHP com o Github Copilot

Olá!! Aqui veremos algumas resoluções de códigos em php utilizando o Github Copilot.
...
O que aprenderemos?
* Utilização de condicionais em php (if, else) para realizar verificações.
...
O que aprenderemos?
* Manipulação de strings em php, especialmente invertendo uma string.
